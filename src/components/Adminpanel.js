			...
			<div className="admin-container">
				<div class="admin-filters">
					...
					<div class="admin-filter-options">
						<label>Sort by:</label>
						<select onChange={this.updateDateFilter} value={this.state.dateFilter}>
							<option onChange={this.updateDateFilter} value="Latest">Latest</option>
							<option onChange={this.updateDateFilter} value="Oldest">Oldest</option>
							<option onChange={this.updateDateFilter} value="This-month">This-month</option>
						</select>
					</div>
				</div>
				...
				<div className="navbar">
					...
					<div className={this.state.activeNav == "Clean" ? "activenav nav-item" : "nav-item"} onClick={() => {this.updateNav("Clean"); }}>
					...
					<div className={this.state.activeNav == "Not Found" ? "activenav nav-item" : "nav-item"} onClick={() => {this.updateNav("Not Found");}}>
