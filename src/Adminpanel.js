...
import WarningOverlay from './components/warningOverlay.js';
import $ from "jquery";
		...
		return (
			<div id='admin-panel'>
				...
				<div className="navbar">
					...
					<div className={this.state.activeNav == "notfound" ? "activenav nav-item" : "nav-item"} onClick={() =>this.updateNav("notfound")}>
